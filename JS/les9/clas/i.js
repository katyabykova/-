...
for (let el of simpsons){
 ...
 div.innerText = `${el.name} ${el.surname} ${el.age} ${el.info}`;
...
for (let el of simpsons) {
    ...
    document.body.append(divSurname);
...
for(let el of coursesArray){
    ...
    divTitle.innerText = el.title;
    div.append(divTitle);
    let divMonth = document.createElement('div');
    divMonth.innerText = el.monthDuration;
    div.append(divMonth);
    let divHour = document.createElement('div');
    divHour.innerText = el.hourDuration;
    div.append(divHour);
